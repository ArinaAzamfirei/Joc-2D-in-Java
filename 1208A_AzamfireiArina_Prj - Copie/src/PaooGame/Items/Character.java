...
public abstract class Character extends Item
{
    ...
    protected int score;    /*!< Retine scorul jucatorului.*/
    ...
    public void MoveX()
    {int tx;
        ///Aduna la pozitia curenta numarul de pixeli cu care trebuie sa se deplaseze pe axa X(incluzand coliziunile)
    ...
    {
        int ty;
        ///Aduna la pozitia curenta numarul de pixeli cu care trebuie sa se deplaseze pe axa Y.(incluzand coliziunile)
        if(yMove<0)
        {
    ...
    /*! \fn public int collision(int x, int y)
        returneaza daca dala de la coordonatele (x,y) are proprietatea solid pt. a putea implementa coliziunile
     */
