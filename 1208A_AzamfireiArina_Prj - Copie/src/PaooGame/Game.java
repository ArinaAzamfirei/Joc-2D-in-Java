...
public class Game implements Runnable
{
    ...
    private State youloststate;
    private State lastlevelstate;
    private State youwonstate;
    private MouseManager mouseManager;  /* Referinta catre obiectul care gestioneaza intrarile de la mouse */
    ...
    private void InitGame()
    {
        ...
        lastlevelstate= new LastLevelState(refLink);
        youwonstate=new YouWonState(refLink);
    ...
    private void Update()
    {
        ...
        if(State.GetState() != null)
        {
            ...
            wnd.GetWndFrame().requestFocusInWindow();    /// A trebui adaugat deoarece KeyManager nu functiona.
        }
    }
    ...
    public State getLastlevelState(){return  lastlevelstate;}
    public State getYouwonstate(){return youwonstate;}
