 ...
 */
public class YouLostState extends PlayState
{
    ...
    public void Update()
    {
        ...
        if (refLink.GetMouseManager().getMouseX() >= 467 && refLink.GetMouseManager().getMouseX() <= 916) //coordonate calculate folosind print-ul de mai sus
        {

            if (refLink.GetMouseManager().getMouseY() >= 444 && refLink.GetMouseManager().getMouseY() <= 490) //coordonate calculate folosind print-ul de mai sus
            {
    ...
    ///functie pentru reluarea jocului in cazul in care jucatorul alege acest lucru
    ...
    public void Draw(Graphics g)
    {
        ...
        g.drawImage(Assets.YouLost, 0, 0, refLink.GetWidth(), refLink.GetHeight(), null);
    }
}
